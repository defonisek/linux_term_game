	...
	1: [
		{
			...
			"messages": [
				...
				"не будем тратить много времени. мне известно, что ты ничего не смыслишь в таких компьютерах. ничего страшного, меня поставили помочь обнаружить тебе секреты, которые прячет эта система.",
				"это - терминал. способ взаимодействия с компьютером, с файлами и системой в целом. оно принимает *команды* и выполняет их.",
				"давай попробуем что-нибудь ввести в терминал.",
                "вернись туда и попробуй написать \"help\". это должно выдать тебе список команд."
			]
		},
